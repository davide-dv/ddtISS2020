		...
		return { //this:ActionBasciFsm
				state("handleRequest") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="checkTemperature",cond=whenDispatch("notify"))
					transition(edgeName="t01",targetState="showWaiterResponse",cond=whenReply("accept"))
					transition(edgeName="t02",targetState="showWaiterResponse",cond=whenReply("inform"))
				}	 
