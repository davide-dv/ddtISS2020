		...
		return { //this:ActionBasciFsm
				state("handleRequest") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t024",targetState="enable",cond=whenDispatch("startTimer1"))
				}	 
				state("enable") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t125",targetState="notifyTimeElapsed",cond=whenTimeout("local_tout_timer1_enable"))   
					transition(edgeName="t126",targetState="handleRequest",cond=whenDispatch("stopTimer1"))
				}	 
