		...
		return { //this:ActionBasciFsm
				state("handleUpdate") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t027",targetState="setStatus",cond=whenEvent("updateCheckTemperature"))
					transition(edgeName="t028",targetState="setStatus",cond=whenEvent("updateWaiterResponse"))
					transition(edgeName="t029",targetState="setStatus",cond=whenEvent("updateTableCheck"))
					transition(edgeName="t030",targetState="setStatus",cond=whenEvent("updateConvoyClient"))
					transition(edgeName="t031",targetState="setStatus",cond=whenEvent("updateTransmit"))
					transition(edgeName="t032",targetState="setStatus",cond=whenEvent("updateDeliver"))
					transition(edgeName="t033",targetState="setStatus",cond=whenEvent("updateCollect"))
					transition(edgeName="t034",targetState="setStatus",cond=whenEvent("updateTableClean"))
					transition(edgeName="t035",targetState="setStatus",cond=whenEvent("updatePrepareTea"))
					transition(edgeName="t036",targetState="setStatus",cond=whenEvent("updateWaiterHandleRequest"))
					transition(edgeName="t037",targetState="setStatus",cond=whenEvent("updateSmartbellHandleRequest"))
					transition(edgeName="t038",targetState="setStatus",cond=whenEvent("updateBarmanWaitingOrder"))
				}	 
