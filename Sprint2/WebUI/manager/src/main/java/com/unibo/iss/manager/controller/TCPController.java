...
public class TCPController {
    ...
    public TCPController(SimpMessagingTemplate template) {
	this.template = template;
        this.handler = new Handlers(this.template);
        smartbell.setURI(this.uriStr);
        smartbell.observe(coapHandler(this.handler.smartbell));
        waiter.setURI(this.uriWaiter);
        waiter.observe(coapHandler(this.handler.waiter));
        barman.setURI(this.uriBarman);
        barman.observe(coapHandler(this.handler.barman));
    }
